...
def hunting(email):	
    ...
    'ig_sig_key_version': '4',
		...
		try:
			...
			name = None
		date = date_sc(Id)			
		requests.post(f"""https://api.telegram.org/bot{tok}/sendvideo?chat_id={iD}&parse_mode=MarkdownV2&video=https://t.me/yyyy/15&caption=*â€¢ Cehennem Geliyor...
â€¢ ||Ben En Ä°yisi OlacaÄŸÄ±m.||*
""");hunt = ("""
𝐓𝐈𝐊𝐓𝐎𝐊
ㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ
• Ad Wagner : {}
